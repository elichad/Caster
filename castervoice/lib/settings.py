        ...
        with io.open(_SETTINGS_PATH, "rt", encoding="utf-8") as toml_file:
            ...
            if os.path.isfile(engine_path):
                ...
                try:
                    ...
                    printer.out(
                        "Error saving settings file {} {} ".format(e, _SETTINGS_PATH)
                    )
                return engine_path
    else:
...
def _get_defaults():
    ...
    return {
        "paths": {
            ...
            "GDEF_FILE": str(Path(_USER_DIR).joinpath("transformers/words.txt")),
            ...
            # EXECUTABLES
            "AHK_PATH": str(Path(_BASE_PATH).joinpath(ahk_path_default)),
            ...
            "WSR_PATH": str(
                Path(_BASE_PATH).joinpath("C:/Windows/Speech/Common/sapisvr.exe")
            ),
        ...
        "hooks": {"default_hooks": ["PrinterHook"],},
        ...
        "formats": {
            "_default": {"text_format": [5, 0], "secondary_format": [1, 0],},
            "C plus plus": {"text_format": [3, 1], "secondary_format": [2, 1],},
            "C sharp": {"text_format": [3, 1], "secondary_format": [2, 1],},
            "Dart": {"text_format": [3, 1], "secondary_format": [2, 1],},
            "HTML": {"text_format": [5, 0], "secondary_format": [5, 2],},
            "Java": {"text_format": [3, 1], "secondary_format": [2, 1],},
            "Javascript": {"text_format": [3, 1], "secondary_format": [2, 1],},
            "matlab": {"text_format": [3, 1], "secondary_format": [1, 3],},
            "Python": {"text_format": [5, 3], "secondary_format": [2, 1],},
            "Rust": {"text_format": [5, 3], "secondary_format": [2, 1],},
            "sequel": {"text_format": [5, 3], "secondary_format": [1, 3],},
        },
    }
